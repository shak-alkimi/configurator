          ...
          <div className="grid grid-cols-12 gap-4 items-end">
            ...
            <div className="col-span-1 space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setNewRun({ ...newRun, driver_type: value })}
              >
                <SelectTrigger className="h-9">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="60w">60W</SelectItem>
                  <SelectItem value="96w">96W</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="col-span-1">
              <Button onClick={handleAdd} size="sm" className="w-full hover:opacity-90 text-xs" style={{ backgroundColor: '#e9ff64', color: '#000', height: '36px' }}>
          ...
          <Card key={run.id} className="border-slate-200">
            <CardContent className="py-3 px-4">
              ...
              <div className="flex items-center gap-3 flex-1">
               <div className="flex-1 grid gap-5 text-xs min-w-0" style={{gridTemplateColumns: '0.9fr 0.8fr 1fr 1fr 1fr 1fr 1fr 0.9fr'}}>
               ...
               <div className="min-w-0">
                 <div className="text-xs text-slate-500 whitespace-nowrap">Driver</div>
                 <div className="text-sm whitespace-nowrap">{(run.driver_type || '60w').toUpperCase()}</div>
               </div>
               <div className="min-w-0">
