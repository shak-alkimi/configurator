    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="border-b border-slate-700 bg-slate-900/50 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 py-6">
          ...
          />
          <h1 className="text-3xl font-bold text-white">Welcome back, {userInfo?.full_name?.split(' ')[0]}</h1>
          <p className="text-slate-400 mt-1">Manage your tape lighting projects</p>
        </div>
      </div>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-8 flex flex-col items-center justify-center text-center h-full gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">View details for approved projects</p>
              </div>
