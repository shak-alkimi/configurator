      ...
      <div className="w-80 p-4 flex flex-col">
        <Card className="h-full flex flex-col">
          <CardHeader className="pb-3">
            <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/698fc81203f85a20f281d9dc/2d6a34c34_Screenshot2026-02-16173430.png" alt="Alkimi Logo" className="h-10 w-auto" />
